<%@ Page Title="" Language="C#" MasterPageFile="~/Registros/MPRegistros.master" AutoEventWireup="true" CodeBehind="Materiales.aspx.cs" Inherits="WEB.Registros.Materiales" %>
        ...
        <ContentTemplate>
                <table>
                     <caption>
                       <h2 class="tituloForm" style="width: 783px">
                           Listado de Materiales</h2>
                      </caption>

                    
            <tr>
                <td class="auto-style16" style="width: 189px">
                    Seleccione Material:</td>
                <td class="auto-style15" colspan="2">
                    <asp:DropDownList ID="cboMaterial" runat="server"  Width="192px">
                    </asp:DropDownList>
                </td>
            </tr>
                ...
                <td class="auto-style15" colspan="2">
                    <asp:DropDownList ID="cboEncargadoMaterial" runat="server"  Width="192px">
                    </asp:DropDownList>
                </td>
            </tr>
            ...
            <tr>
                <td class="auto-style16" style="width: 189px">
                     Aprobado por:</td>
                <td class="auto-style15" colspan="2">
                    <asp:DropDownList ID="cboAprobadoPorMaterial" runat="server"  Width="192px">
                    </asp:DropDownList>
                </td>
            </tr>

                    <tr>
                <td class="labelContenido" style="width: 189px">
                    Ingrese fecha Aprobación:</td>
                <td style="width: 100px; height: 21px" colspan="2">
                    <asp:TextBox ID="txtFecAprobacionMaterial" runat="server" Width="96px"></asp:TextBox>
                    <ajaxToolkit:CalendarExtender ID="txtFecAprobacionMaterial_CalendarExtender" runat="server" Enabled="True" TargetControlID="txtFecAprobacionMaterial">
                    </ajaxToolkit:CalendarExtender>
                </td>
            </tr>

            <tr>
                <td class="labelContenido" style="height: 26px; width: 189px;">
            ...
            <tr>
                    <td align="left" class="auto-style7" style="width: 189px">
                        Notas:
                    </td>
                    <td align="left" class="auto-style8">
                        <asp:TextBox ID="TextBox1" runat="server" Width="600px" style="margin-left: 0px"></asp:TextBox>
                        &nbsp;</td>
            </tr>


            <tr>
                <td class="auto-style13" style="width: 189px">
                    &nbsp;</td>
            ...
            <tr>
                <td class="auto-style20" style="width: 189px">
                    <asp:Button ID="btnAgregar" runat="server" CssClass="boton2" Text="Agregar Detalle" Width="150px" />
                </td>
                <td class="auto-style21">
                    <asp:Button ID="btnGrabar" runat="server" CssClass="boton2"  Text="Grabar" Width="150px" />
                ...
                <td class="auto-style21">
                    <asp:Button ID="btnCancelar" runat="server" CssClass="boton-new" PostBackUrl="~/Registros/MPRegistros.master" Text="Cancelar" Width="150px" />
                </td>
            </tr>
                ...
                <td colspan="3">
                    &nbsp;<asp:GridView ID="grDetalles" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#DEDFDE" BorderStyle="None" BorderWidth="1px" CellPadding="4" ForeColor="Black" GridLines="Vertical"  Width="936px" ShowHeaderWhenEmpty="True">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="" HeaderText="Material" />
