...
{
  public partial class frmListarReporteSupervision : Form
  {
    public frmListarReporteSupervision()
    {
      InitializeComponent();
    }
        ...
        private void frmListarReporteSupervision_Load(object sender, EventArgs e) {
            try {
        ...
        private void btnNuevo_Click(object sender, EventArgs e) {
            frmNuevoReporteSupervision frmRep = new frmNuevoReporteSupervision();
            frmRep.ShowDialog();
            cargar();
        }
        ...
        private void btnModificar_Click(object sender, EventArgs e) {
            try {
                frmModificarReporteSupervision modEntr = new frmModificarReporteSupervision();
