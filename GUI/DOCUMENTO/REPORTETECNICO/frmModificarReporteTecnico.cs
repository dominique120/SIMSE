...
namespace GUI.DOCUMENTO.REPORTETECNICO {
    public partial class frmModificarReporteTecnico : Form {

        private int idDocumento;
        public int IdDocumento { get => idDocumento; set => idDocumento = value; }
        public frmModificarReporteTecnico() {
            InitializeComponent();
        }
        ...
        private void frmModificarReporteTecnico_Load(object sender, EventArgs e) {
            try {
